...
<head>        <!--        * Author:         OverAPI        -->
    <meta charset="utf-8"/>
    <title>jQuery Cheat Sheet | OverAPI.com</title>
    ...
    <script type="text/javascript" src="/static/js/main.js"></script>        <!-- start Mixpanel -->
    ...
    mixpanel.init("ed50c28311513adf4b2293887b710db6");</script><!-- end Mixpanel -->    </head>
<body class="cheat-detail">
<div id="more-list-container"><a href="javascript:void(0)">More &raquo;</a>
    <ul id="nav-more-list">
...
<div id="navbar"><a id="logo" href="/">OverAPI.com</a>
...
<div style="position:fixed;right:105px;top:10px;z-index:200;"><input type="" id="searchApi" placeholder="Search"/></div>
<div class="addthis_toolbox addthis_default_style" style="position:fixed;right:5px;top:17px;z-index:200;"><a
        class="addthis_button_facebook"></a> <a class="addthis_button_twitter"></a> <a
        class="addthis_button_sinaweibo"></a> <a class="addthis_button_compact"></a></div>
<div class="loading"> Loading...</div>
<div class="content">
    <div class="board"><h2 class="board-title">Resource</h2>
        <div class="board-card"><h3 class="board-card-title">Online</h3>
            <ul>
                <li><a href="http://jquery.com">Official Website</a></li>
            </ul>
        </div>
        <div class="board-card"><h3 class="board-card-title">Download</h3>
            <ul>
                <li><a href="/static/cs/jQuery-1.5-Visual-Cheat-Sheet.pdf">jQuery 1.5 Visual Cheat Sheet [.pdf]</a></li>
            </ul>
        </div>
        <div class="board-card"><h3 class="board-card-title">Related</h3>
            <ul>
    ...
    <div class="board"><h2 class="board-title">Selectors</h2>
        <div class="board-card"><h3 class="board-card-title">Attribute</h3>
            <ul>
                <li>
                    <a title="Selects elements that have the specified attribute with a value either equal to a given string or starting with that string followed by a hyphen (-)."
                       href="http://api.jquery.com/attribute-contains-prefix-selector/">[name|="value"]</a></li>
                <li>
                    <a title="Selects elements that have the specified attribute with a value containing the a given substring."
                       href="http://api.jquery.com/attribute-contains-selector/">[name*="value"]</a></li>
                <li>
                    <a title="Selects elements that have the specified attribute with a value containing a given word, delimited by spaces."
                       href="http://api.jquery.com/attribute-contains-word-selector/">[name~="value"]</a></li>
                <li>
                    <a title="Selects elements that have the specified attribute with a value ending exactly with a given string. The comparison is case sensitive."
                       href="http://api.jquery.com/attribute-ends-with-selector/">[name$="value"]</a></li>
                <li>
                    <a title="Selects elements that have the specified attribute with a value exactly equal to a certain value."
                       href="http://api.jquery.com/attribute-equals-selector/">[name="value"]</a></li>
                <li>
                    <a title="Select elements that either don't have the specified attribute, or do have the specified attribute but not with a certain value."
                       href="http://api.jquery.com/attribute-not-equal-selector/">[name!="value"]</a></li>
                <li>
                    <a title="Selects elements that have the specified attribute with a value beginning exactly with a given string."
        ...
        <div class="board-card"><h3 class="board-card-title">Forms</h3>
            <ul>
                <li><a title="Selects all button elements and elements of type button."
                       href="http://api.jquery.com/button-selector/">:button</a></li>
                <li><a title="Selects all elements of type checkbox." href="http://api.jquery.com/checkbox-selector/">:checkbox</a>
                </li>
                <li><a title="Matches all elements that are checked." href="http://api.jquery.com/checked-selector/">:checked</a>
                </li>
                <li><a title="Selects all elements that are disabled." href="http://api.jquery.com/disabled-selector/">:disabled</a>
                </li>
                <li><a title="Selects all elements that are enabled." href="http://api.jquery.com/enabled-selector/">:enabled</a>
                </li>
                <li><a title="Selects element if it is currently focused." href="http://api.jquery.com/focus-selector/">:focus</a>
                </li>
                <li><a title="Selects all elements of type file." href="http://api.jquery.com/file-selector/">:file</a>
                </li>
                <li><a title="Selects all elements of type image."
                       href="http://api.jquery.com/image-selector/">:image</a></li>
                <li><a title="Selects all input, textarea, select and button elements."
                       href="http://api.jquery.com/input-selector/">:input</a></li>
                <li><a title="Selects all elements of type password." href="http://api.jquery.com/password-selector/">:password</a>
                </li>
                <li><a title="Selects all elements of type radio."
                       href="http://api.jquery.com/radio-selector/">:radio</a></li>
                <li><a title="Selects all elements of type reset."
                       href="http://api.jquery.com/reset-selector/">:reset</a></li>
                <li><a title="Selects all elements that are selected." href="http://api.jquery.com/selected-selector/">:selected</a>
                </li>
                <li><a title="Selects all elements of type submit." href="http://api.jquery.com/submit-selector/">:submit</a>
                </li>
                <li><a title="Selects all elements of type text." href="http://api.jquery.com/text-selector/">:text</a>
                </li>
            </ul>
        </div>
        <div class="board-card"><h3 class="board-card-title">Basics</h3>
            <ul>
                <li><a title="Selects all elements." href="http://api.jquery.com/all-selector/">*</a></li>
                <li><a title="Selects all elements with the given class." href="http://api.jquery.com/class-selector/">.class</a>
                </li>
        ...
        <div class="board-card"><h3 class="board-card-title">Visibility Filters</h3>
            <ul>
                <li><a title="Selects all elements that are hidden." href="http://api.jquery.com/hidden-selector/">:hidden</a>
                </li>
                <li><a title="Selects all elements that are visible." href="http://api.jquery.com/visible-selector/">:visible</a>
                </li>
            </ul>
        </div>
        <div class="board-card"><h3 class="board-card-title">Basic Filters</h3>
            <ul>
                <li>
                    <a title="Select all elements that are in the progress of an animation at the time the selector is run."
                ...
                <li><a title="Selects the first matched element."
                       href="http://api.jquery.com/first-selector/">:first</a></li>
                ...
                <li><a title="Selects the last matched element." href="http://api.jquery.com/last-selector/">:last</a>
                </li>
        ...
        <div class="board-card"><h3 class="board-card-title">Child Filters</h3>
            <ul>
        ...
        <div class="board-card"><h3 class="board-card-title">Content Filters</h3>
            <ul>
        ...
        <div class="board-card"><h3 class="board-card-title">Hierarchy</h3>
            <ul>
                ...
                <li>
                    <a title="Selects all next elements matching 'next' that are immediately preceded by a sibling 'prev'."
                       href="http://api.jquery.com/next-adjacent-Selector/">prev + next</a></li>
                <li>
                    <a title="Selects all sibling elements that follow after the 'prev' element, have the same parent, and match the filtering 'siblings' selector."
                       href="http://api.jquery.com/next-siblings-selector/">prev ~ siblings</a></li>
            </ul>
        </div>
    </div>
    <div class="board"><h2 class="board-title">Attributes / CSS</h2>
        <div class="board-card"><h3 class="board-card-title">Attributes</h3>
            <ul>
        ...
        <div class="board-card"><h3 class="board-card-title">CSS</h3>
            <ul>
                ...
                <li>
                    <a title="Provides a way to hook directly into jQuery to override how particular CSS properties are retrieved or set. Amongst other uses, cssHooks can be used to create custom, browser-normalized properties for CSS3 features such as box-shadows and gradients."
                ...
                <li>
                    <a title="Remove a single class, multiple classes, or all classes from each element in the set of matched elements."
                       href="http://api.jquery.com/removeClass/">.removeClass()</a></li>
                <li>
                    <a title="Add or remove one or more classes from each element in the set of matched elements, depending on either the class's presence or the value of the switch argument."
                       href="http://api.jquery.com/toggleClass/">.toggleClass()</a></li>
            </ul>
        </div>
        <div class="board-card"><h3 class="board-card-title">Dimensions</h3>
            <ul>
                ...
                <li>
                    <a title="Get the current computed height for the first element in the set of matched elements, including padding but not border."
                       href="http://api.jquery.com/innerHeight/">.innerHeight()</a></li>
                <li>
                    <a title="Get the current computed width for the first element in the set of matched elements, including padding but not border."
                       href="http://api.jquery.com/innerWidth/">.innerWidth()</a></li>
                <li>
                    <a title="Get the current computed height for the first element in the set of matched elements, including padding, border, and optionally margin."
                       href="http://api.jquery.com/outerHeight/">.outerHeight()</a></li>
                <li>
                    <a title="Get the current computed width for the first element in the set of matched elements, including padding and border."
        ...
        <div class="board-card"><h3 class="board-card-title">Offset</h3>
            <ul>
                <li>
                    <a title="Get the current coordinates of the first element in the set of matched elements, relative to the document."
                ...
                <li>
                    <a title="Get the current coordinates of the first element in the set of matched elements, relative to the offset parent."
                       href="http://api.jquery.com/position/">.position()</a></li>
                <li>
                    <a title="Get the current horizontal position of the scroll bar for the first element in the set of matched elements."
                       href="http://api.jquery.com/scrollLeft/">.scrollLeft()</a></li>
                <li>
                    <a title="Get the current vertical position of the scroll bar for the first element in the set of matched elements."
                       href="http://api.jquery.com/scrollTop/">.scrollTop()</a></li>
            </ul>
        </div>
        <div class="board-card"><h3 class="board-card-title">Data</h3>
            <ul>
                ...
                <li><a title="Remove a previously-stored piece of data." href="http://api.jquery.com/removeData/">.removeData()</a>
                </li>
            </ul>
        </div>
    </div>
    <div class="board"><h2 class=" board-title">Manipulation</h2>
        <div class="board-card"><h3 class="board-card-title">Copying</h3>
            <ul>
                <li><a title="Create a deep copy of the set of matched elements." href="http://api.jquery.com/clone/">.clone()</a>
                </li>
            </ul>
        </div>
        <div class="board-card"><h3 class="board-card-title">DOM Insertion, Around</h3>
            <ul>
        ...
        <div class="board-card"><h3 class="board-card-title">DOM Insertion, Inside</h3>
            <ul>
                <li>
                    <a title="Insert content, specified by the parameter, to the end of each element in the set of matched elements."
                ...
                <li>
                    <a title="Insert content, specified by the parameter, to the beginning of each element in the set of matched elements."
                ...
                <li>
                    <a title="Get the combined text contents of each element in the set of matched elements, including their descendants."
                       href="http://api.jquery.com/text/">.text()</a></li>
            </ul>
        </div>
        <div class="board-card"><h3 class="board-card-title">DOM Insertion, Outside</h3>
            <ul>
                <li>
                    <a title="Insert content, specified by the parameter, after each element in the set of matched elements."
                       href="http://api.jquery.com/after/">.after()</a></li>
                <li>
                    <a title="Insert content, specified by the parameter, before each element in the set of matched elements."
        ...
        <div class="board-card"><h3 class="board-card-title">DOM Removal</h3>
            <ul>
                <li><a title="Remove the set of matched elements from the DOM." href="http://api.jquery.com/detach/">.detach()</a>
                </li>
                <li><a title="Remove all child nodes of the set of matched elements from the DOM."
                       href="http://api.jquery.com/empty/">.empty()</a></li>
                <li><a title="Remove the set of matched elements from the DOM." href="http://api.jquery.com/remove/">.remove()</a>
                </li>
                <li>
                    <a title="Remove the parents of the set of matched elements from the DOM, leaving the matched elements in their place."
                       href="http://api.jquery.com/unwrap/">.unwrap()</a></li>
            </ul>
        </div>
        <div class="board-card"><h3 class="board-card-title">DOM Replacement</h3>
            <ul>
    ...
    <div class="board"><h2 class="board-title">Traversing</h2>
        <div class="board-card"><h3 class="board-card-title">Filtering</h3>
            <ul>
                <li><a title="Reduce the set of matched elements to the one at the specified index."
                       href="http://api.jquery.com/eq/">.eq()</a></li>
                <li>
                    <a title="Reduce the set of matched elements to those that match the selector or pass the function's test."
                ...
                <li>
                    <a title="Reduce the set of matched elements to those that have a descendant that matches the selector or DOM element."
                       href="http://api.jquery.com/has/">.has()</a></li>
                <li>
                    <a title="Check the current matched set of elements against a selector and return true if at least one of these elements matches the selector."
                ...
                <li>
                    <a title="Pass each element in the current matched set through a function, producing a new jQuery object containing the return values."
                       href="http://api.jquery.com/map/">.map()</a></li>
                <li><a title="Remove elements from the set of matched elements." href="http://api.jquery.com/not/">.not()</a>
                </li>
        ...
        <div class="board-card"><h3 class="board-card-title">Miscellaneous Traversing</h3>
            <ul>
                ...
                <li>
                    <a title="Get the children of each element in the set of matched elements, including text and comment nodes."
                       href="http://api.jquery.com/contents/">.contents()</a></li>
                <li>
                    <a title="End the most recent filtering operation in the current chain and return the set of matched elements to its previous state."
                       href="http://api.jquery.com/end/">.end()</a></li>
            </ul>
        </div>
        <div class="board-card"><h3 class="board-card-title">Tree Traversal</h3>
            <ul>
                <li>
                    <a title="Get the children of each element in the set of matched elements, optionally filtered by a selector."
                       href="http://api.jquery.com/children/">.children()</a></li>
                <li>
                    <a title="Get the first ancestor element that matches the selector, beginning at the current element and progressing up through the DOM tree."
                       href="http://api.jquery.com/closest/">.closest()</a></li>
                <li>
                    <a title="Get the descendants of each element in the current set of matched elements, filtered by a selector."
                       href="http://api.jquery.com/find/">.find()</a></li>
                <li>
                    <a title="Get the immediately following sibling of each element in the set of matched elements. If a selector is provided, it retrieves the next sibling only if it matches that selector."
                       href="http://api.jquery.com/next/">.next()</a></li>
                <li>
                    <a title="Get all following siblings of each element in the set of matched elements, optionally filtered by a selector."
                       href="http://api.jquery.com/nextAll/">.nextAll()</a></li>
                <li>
                    <a title="Get all following siblings of each element up to but not including the element matched by the selector."
                       href="http://api.jquery.com/nextUntil/">.nextUntil()</a></li>
                <li>
                    <a title="Get the parent of each element in the current set of matched elements, optionally filtered by a selector."
                       href="http://api.jquery.com/parent/">.parent()</a></li>
                <li>
                    <a title="Get the ancestors of each element in the current set of matched elements, optionally filtered by a selector."
                       href="http://api.jquery.com/parents/">.parents()</a></li>
                <li>
                    <a title="Get the ancestors of each element in the current set of matched elements, up to but not including the element matched by the selector."
                       href="http://api.jquery.com/parentsUntil/">.parentsUntil()</a></li>
                <li>
                    <a title="Get the immediately preceding sibling of each element in the set of matched elements, optionally filtered by a selector."
                       href="http://api.jquery.com/prev/">.prev()</a></li>
                <li>
                    <a title="Get all preceding siblings of each element in the set of matched elements, optionally filtered by a selector."
                       href="http://api.jquery.com/prevAll/">.prevAll()</a></li>
                <li>
                    <a title="Get all preceding siblings of each element up to but not including the element matched by the selector."
                       href="http://api.jquery.com/prevUntil/">.prevUntil()</a></li>
                <li>
                    <a title="Get the siblings of each element in the set of matched elements, optionally filtered by a selector."
                       href="http://api.jquery.com/siblings/">.siblings()</a></li>
            </ul>
        </div>
    </div>
    <div class="board"><h2 class="board-title">Events</h2>
        <div class="board-card"><h3 class="board-card-title">Event Object</h3>
            <ul>
                ...
                <li>
                    <a title="The last value returned by an event handler that was triggered by this event, unless the value was undefined."
                       href="http://api.jquery.com/event.result/">event.result</a></li>
                <li><a title="Prevents other event handlers from being called."
                       href="http://api.jquery.com/event.stopImmediatePropagation/">event.stopImmediatePropagation()</a>
                </li>
                <li>
                    <a title="Prevents the event from bubbling up the DOM tree, preventing any parent handlers from being notified of the event."
                       href="http://api.jquery.com/event.stopPropagation/">event.stopPropagation()</a></li>
                <li><a title="The DOM element that initiated the event." href="http://api.jquery.com/event.target/">event.target</a>
                </li>
                <li>
                    <a title="The difference in milliseconds between the time an event is triggered and January 1, 1970."
                       href="http://api.jquery.com/event.timeStamp/">event.timeStamp</a></li>
                <li><a title="Describes the nature of the event."
                       href="http://api.jquery.com/event.type/">event.type</a></li>
                <li>
                    <a title="For key or button events, this attribute indicates the specific button or key that was pressed."
                       href="http://api.jquery.com/event.which/">event.which</a></li>
            </ul>
        </div>
        <div class="board-card"><h3 class="board-card-title">Mouse Events</h3>
            <ul>
                <li>
                    <a title="Bind an event handler to the 'click' JavaScript event, or trigger that event on an element."
                       href="http://api.jquery.com/click/">.click()</a></li>
                <li>
                    <a title="Bind an event handler to the 'dblclick' JavaScript event, or trigger that event on an element."
                ...
                <li>
                    <a title="Bind two handlers to the matched elements, to be executed when the mouse pointer enters and leaves the elements."
                       href="http://api.jquery.com/hover/">.hover()</a></li>
                <li>
                    <a title="Bind an event handler to the 'mousedown' JavaScript event, or trigger that event on an element."
                       href="http://api.jquery.com/mousedown/">.mousedown()</a></li>
                <li>
                    <a title="Bind an event handler to be fired when the mouse enters an element, or trigger that handler on an element."
                       href="http://api.jquery.com/mouseenter/">.mouseenter()</a></li>
                <li>
                    <a title="Bind an event handler to be fired when the mouse leaves an element, or trigger that handler on an element."
                       href="http://api.jquery.com/mouseleave/">.mouseleave()</a></li>
                <li>
                    <a title="Bind an event handler to the 'mousemove' JavaScript event, or trigger that event on an element."
                       href="http://api.jquery.com/mousemove/">.mousemove()</a></li>
                <li>
                    <a title="Bind an event handler to the 'mouseout' JavaScript event, or trigger that event on an element."
                       href="http://api.jquery.com/mouseout/">.mouseout()</a></li>
                <li>
                    <a title="Bind an event handler to the 'mouseover' JavaScript event, or trigger that event on an element."
                       href="http://api.jquery.com/mouseover/">.mouseover()</a></li>
                <li>
                    <a title="Bind an event handler to the 'mouseup' JavaScript event, or trigger that event on an element."
        ...
        <div class="board-card"><h3 class="board-card-title">Browser Events</h3>
            <ul>
                <li><a title="Bind an event handler to the 'error' JavaScript event."
                       href="http://api.jquery.com/error/">.error()</a></li>
                <li>
                    <a title="Bind an event handler to the 'resize' JavaScript event, or trigger that event on an element."
                       href="http://api.jquery.com/resize/">.resize()</a></li>
                <li>
                    <a title="Bind an event handler to the 'scroll' JavaScript event, or trigger that event on an element."
                       href="http://api.jquery.com/scroll/">.scroll()</a></li>
            </ul>
        </div>
        <div class="board-card"><h3 class="board-card-title">Document Loading</h3>
            <ul>
        ...
        <div class="board-card"><h3 class="board-card-title">Event Handler Attachment</h3>
            <ul>
                <li><a title="Attach a handler to an event for the elements."
                       href="http://api.jquery.com/bind/">.bind()</a></li>
                <li>
                    <a title="Attach a handler to one or more events for all elements that match the selector, now or in the future, based on a specific set of root elements."
                ...
                <li>
                    <a title="Attach a handler to the event for all elements which match the current selector, now and in the future."
                ...
                <li>
                    <a title="Attach a handler to an event for the elements. The handler is executed at most once per element."
                       href="http://api.jquery.com/one/">.one()</a></li>
                <li>
                    <a title="Execute all handlers and behaviors attached to the matched elements for the given event type."
                ...
                <li>
                    <a title="Remove a handler from the event for all elements which match the current selector, now or in the future, based upon a specific set of root elements."
                       href="http://api.jquery.com/undelegate/">.undelegate()</a></li>
            </ul>
        </div>
        <div class="board-card"><h3 class="board-card-title">Form Events</h3>
            <ul>
                <li>
                    <a title="Bind an event handler to the 'blur' JavaScript event, or trigger that event on an element."
                       href="http://api.jquery.com/blur/">.blur()</a></li>
                <li>
                    <a title="Bind an event handler to the 'change' JavaScript event, or trigger that event on an element."
                       href="http://api.jquery.com/change/">.change()</a></li>
                <li>
                    <a title="Bind an event handler to the 'focus' JavaScript event, or trigger that event on an element."
                       href="http://api.jquery.com/focus/">.focus()</a></li>
                <li>
                    <a title="Bind an event handler to the 'select' JavaScript event, or trigger that event on an element."
                       href="http://api.jquery.com/select/">.select()</a></li>
                <li>
                    <a title="Bind an event handler to the 'submit' JavaScript event, or trigger that event on an element."
                       href="http://api.jquery.com/submit/">.submit()</a></li>
            </ul>
        </div>
        <div class="board-card"><h3 class="board-card-title">Keyboard Events</h3>
            <ul>
                <li>
                    <a title="Bind an event handler to the 'keydown' JavaScript event, or trigger that event on an element."
                       href="http://api.jquery.com/keydown/">.keydown()</a></li>
                <li>
                    <a title="Bind an event handler to the 'keypress' JavaScript event, or trigger that event on an element."
                       href="http://api.jquery.com/keypress/">.keypress()</a></li>
                <li>
                    <a title="Bind an event handler to the 'keyup' JavaScript event, or trigger that event on an element."
                       href="http://api.jquery.com/keyup/">.keyup()</a></li>
            </ul>
        </div>
    </div>
    <div class="board"><h2 class="board-title">Effects</h2>
        <div class="board-card"><h3 class="board-card-title">Basics</h3>
            <ul>
                ...
                <li><a title="Display or hide the matched elements." href="http://api.jquery.com/toggle/">.toggle()</a>
                </li>
            </ul>
        </div>
        <div class="board-card"><h3 class="board-card-title">Custom</h3>
            <ul>
                ...
                <li><a title="Globally disable all animations."
                       href="http://api.jquery.com/jQuery.fx.off">jQuery.fx.off</a></li>
        ...
        <div class="board-card"><h3 class="board-card-title">Fading</h3>
            <ul>
                ...
                <li><a title="Adjust the opacity of the matched elements." href="http://api.jquery.com/fadeTo/">.fadeTo()</a>
                </li>
        ...
        <div class="board-card"><h3 class="board-card-title">Sliding</h3>
            <ul>
                ...
                <li><a title="Hide the matched elements with a sliding motion." href="http://api.jquery.com/slideUp">.slideUp()</a>
                </li>
            </ul>
        </div>
    </div>
    <div class="board"><h2 class="board-title">Ajax</h2>
        <div class="board-card"><h3 class="board-card-title">Global Ajax Event Handlers</h3>
            <ul>
                ...
                <li>
                    <a title="Register a handler to be called when Ajax requests complete with an error. This is an Ajax Event."
                ...
                <li>
                    <a title="Register a handler to be called when the first Ajax request begins. This is an Ajax Event."
                       href="http://api.jquery.com/ajaxStart/">.ajaxStart()</a></li>
                <li>
                    <a title="Register a handler to be called when all Ajax requests have completed. This is an Ajax Event."
                       href="http://api.jquery.com/ajaxStop/">.ajaxStop()</a></li>
                <li>
                    <a title="Attach a function to be executed whenever an Ajax request completes successfully. This is an Ajax Event."
                       href="http://api.jquery.com/ajaxSuccess/">.ajaxSuccess()</a></li>
            </ul>
        </div>
        <div class="board-card"><h3 class="board-card-title">Helper Functions</h3>
            <ul>
                <li>
                    <a title="Create a serialized representation of an array or object, suitable for use in a URL query string or Ajax request."
        ...
        <div class="board-card"><h3 class="board-card-title">Low-Level Interface</h3>
            <ul>
                <li><a title="Perform an asynchronous HTTP (Ajax) request." href="http://api.jquery.com/jQuery.ajax/">jQuery.ajax()</a>
                </li>
                <li><a title="Set default values for future Ajax requests."
                       href="http://api.jquery.com/jQuery.ajaxSetup">jQuery.ajaxSetup()</a></li>
            </ul>
        </div>
        <div class="board-card"><h3 class="board-card-title">Shorthand Methods</h3>
            <ul>
    ...
    <div class="board"><h2 class="board-title">Core</h2>
        <div class="board-card"><h3 class="board-card-title">jQuery Object</h3>
            <ul>
                ...
                <li>
                    <a title="Creates a new copy of jQuery whose properties and methods can be modified without affecting the original jQuery object."
                       href="http://api.jquery.com/jQuery.sub/">jQuery.sub()</a></li>
                <li>
                    <a title="Provides a way to execute callback functions based on one or more objects, usually Deferred objects that represent asynchronous events."
                       href="http://api.jquery.com/jQuery.when/">jQuery.when()</a></li>
            </ul>
        </div>
        <div class="board-card"><h3 class="board-card-title">DOM Element Methods</h3>
            <ul>
                ...
                <li><a title="Return the number of elements in the jQuery object." href="http://api.jquery.com/size/">.size()</a>
                </li>
        ...
        <div class="board-card"><h3 class="board-card-title">Internals</h3>
            <ul>
                <li><a title="A string containing the jQuery version number." href="http://api.jquery.com/.jquery/">.jquery</a>
                </li>
                <li>
                    <a title="The DOM node context originally passed to jQuery(); if none was passed then context will likely be the document."
                ...
                <li><a title="The number of elements in the jQuery object."
                       href="http://api.jquery.com/length/">.length</a></li>
        ...
        <div class="board-card"><h3 class="board-card-title">Deferred Object</h3>
            <ul>
                ...
                <li><a title="Return a Deferred's Promise object." href="http://api.jquery.com/deferred.promise/">deferred.promise()</a>
                </li>
                ...
                <li>
                    <a title="Return a Promise object to observe when all actions of a certain type bound to the collection, queued or not, have finished."
                       href="http://api.jquery.com/promise/">.promise()</a></li>
            </ul>
        </div>
        <div class="board-card"><h3 class="board-card-title">Callbacks Object</h3>
            <ul>
                <li>
                    <a title="A multi-purpose callbacks list object that provides a powerful way to manage callback lists."
                ...
                <li><a title="Remove all of the callbacks from a list." href="http://api.jquery.com/callbacks.empty/">callbacks.empty()</a>
                </li>
                ...
                <li><a title="Lock a callback list in its current state." href="http://api.jquery.com/callbacks.lock/">callbacks.lock()</a>
                </li>
    ...
    <div class="board"><h2 class="board-title">Utilities</h2>
        <div class="board-card"><h3 class="board-card-title">Utilities</h3>
            <ul>
                <li>
                    <a title="Contains flags for the useragent, read from navigator.userAgent. We recommend against using this property; please try to use feature detection instead (see jQuery.support). jQuery.browser may be moved to a plugin in a future release of jQuery."
                ...
                <li>
                    <a title="A generic iterator function, which can be used to seamlessly iterate over both objects and arrays. Arrays and array-like objects with a length property (such as a function's arguments object) are iterated by numeric index, from 0 to length-1. Other objects are iterated via their named properties."
                ...
                <li><a title="Execute some JavaScript code globally." href="http://api.jquery.com/jQuery.globalEval/">jQuery.globalEval()</a>
                </li>
                <li>
                    <a title="Finds the elements of an array which satisfy a filter function. The original array is not affected."
                ...
                <li><a title="Determine whether the argument is an array." href="http://api.jquery.com/jQuery.isArray/">jQuery.isArray()</a>
                </li>
                ...
                <li><a title="Return a number representing the current time." href="http://api.jquery.com/jQuery.now/">jQuery.now()</a>
                </li>
                ...
                <li><a title="Parses a string into an XML document." href="http://api.jquery.com/jQuery.parseXML/">jQuery.parseXML()</a>
                </li>
                ...
                <li>
                    <a title="A collection of properties that represent the presence of different browser features or bugs."
                ...
                <li>
                    <a title="Sorts an array of DOM elements, in place, with the duplicates removed. Note that this only works on arrays of DOM elements, not strings or numbers."
                       href="http://api.jquery.com/jQuery.unique/">jQuery.unique()</a></li>
            </ul>
        </div>
    </div>
</div>        <!--<div class="index-tools hide" style="margin:40px 0;" id="de_donate">-->
...
<!--<input type="hidden" name="currency_code" value="USD">-->                <!--<input type="hidden" name="amount">-->
<!--<input type="image" src="https://www.paypal.com/en_US/i/btn/btn_donateCC_LG.gif" border="0" name="submit" alt="Make payments with PayPal - it's fast, free and secure!">-->
<!--</form>-->        <!--</div>-->        <!--<div class="board board-detail-ad hide">-->
<div class="board hide" id="detail-ad"><h2 class="board-title">Ad</h2>
    <script type="text/javascript"><!--                google_ad_client = "ca-pub-5503280202576307";                /* overapi-160 */                google_ad_slot = "2656228683";                google_ad_width = 160;                google_ad_height = 600;                -->            </script>
    <script type="text/javascript"><
    !--                //google_ad_client = "ca-pub-5503280202576307";                 //overapi-tools */                //google_ad_slot = "0215957718";                //google_ad_width = 728;                //google_ad_height = 90;                -->            </script>
    <script type="text/javascript" src="http://pagead2.googlesyndication.com/pagead/show_ads.js"></script>
</div>
<script type="text/javascript">            $('.content').append($('#detail-ad'));
$('#detail-ad').removeClass('hide');            //$('.board-detail-ad').removeClass('hide');            $(function(){                //$('#de_donate').removeClass('hide');                //mixpanel.track('Page Loading',{'PageURL':location.href});            })        </script>
<script type="text/javascript" src="http://js.tongji.linezing.com/2871480/tongji.js"></script>
<noscript><a href="http://www.linezing.com"><img src="http://img.tongji.linezing.com/2871480/tongji.gif"/></a>
</noscript>
